...
class DeepseekV32Config(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # copied from deepseek_v32
        self.max_seq_len: int = 4096 * 4
        self.original_seq_len =  4096
        self.mscale: float = 1.
        self.original_seq_len: int = 4096
        self.rope_theta: float = 10000.0
        self.rope_factor: float = 40
        self.beta_fast: int = 32
        self.beta_slow: int = 1
        self.mscale: float = 1.
        # index
        self.index_n_heads: int = 64
        self.index_head_dim: int = 128
        self.index_topk: int = 2048
        # self.dim: int = 2048
        self.dim: int = 7168
        self.scale_fmt: Optional[str] = None
        self.max_batch_size: int = 8
        self.kv_lora_rank: int = 512
