...
def dump_cur_ram(msg: str = ""):
    ...
    print(f"[Memory] {msg} Current RAM usage: {round(current_ram, 2)}MB")
...
def quant_ar(model, tokenizer, output_dir):
    ...
    # Dump memory usage before quantization
    dump_memory_usage("before quantization")
    ...
    # Dump memory usage after quantization
    dump_memory_usage("after quantization")
